...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    token=models.CharField(max_length=30,default='',null=True, blank=True)
    type=models.CharField(max_length=10,choices=[("doctor", "doctor"),("patient", "patient")], default='patient',null=True, blank=True)
    language=models.CharField(max_length=5,choices=[("en", "en"),("ar", "ar")], default='en',null=True, blank=True)
